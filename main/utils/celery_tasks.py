from main.utils.shots_analyzer import get_background, get_contrast, get_shot_screenshot, get_shots, get_shots_length, get_shot_text
...
def celery_analyze_shots(video):
    result = []
    celery_chain = chain(get_shots.si(video), get_shot_text.si(video),
