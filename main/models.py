...
class Video(models.Model):
    ...
    #Frame rate
    frame_rate = models.CharField(max_length=64,
                                  blank=True,
                                  null=True,
                                  default="Unknown")
    frame_rate_rating = models.CharField(max_length=64,
                                         blank=True,
                                         null=True,
                                         default="Unknown")
    ...
    bit_rate = models.CharField(max_length=64,
                                ...
                                null=True,
                                default="Unknown")
    bit_rate_rating = models.CharField(max_length=64,
                                       blank=True,
                                       null=True,
                                       default="Unknown")
    ...
    bit_depth = models.CharField(max_length=64,
                                 ...
                                 null=True,
                                 default="Unknown")
    bit_depth_rating = models.CharField(max_length=64,
                                        blank=True,
                                        null=True,
                                        default="Unknown")
    ...
    #Sample rate
    sample_rate = models.CharField(max_length=64,
                                   blank=True,
                                   null=True,
                                   default="Unknown")
    sample_rate_rating = models.CharField(max_length=64,
                                          blank=True,
                                          null=True,
                                          default="Unknown")
    ...
    #Video length
    video_length = models.CharField(max_length=64,
                                    blank=True,
                                    null=True,
                                    default="Unknown")
    video_length_rating = models.CharField(max_length=64,
                                           blank=True,
                                           null=True,
                                           default="Unknown")
